...
exports.removeLastWordFromString = exports.insertToString = exports.pushIntoString = exports.lowercaseFirstLetter = exports.capitalizeFirstLetter = exports.toImportStatements = exports.replaceAllInString = exports.fromLineArray = exports.splitNameType = exports.toLineArray = void 0;
...
const splitNameType = (toSplit) => {
    if (!toSplit || !toSplit.length)
        return { name: "", type: "" };
    if (Array.isArray(toSplit)) {
        return toSplit.map((string) => {
            const splatString = string === null || string === void 0 ? void 0 : string.split(":");
            return { name: splatString[0].trim(), type: splatString[1].trim() };
        });
    }
    else {
        const splatString = toSplit === null || toSplit === void 0 ? void 0 : toSplit.split(":");
        return { name: splatString[0].trim(), type: splatString[1].trim() };
    }
};
...
const pushIntoString = (stringToPushTo, handlerA, handlerB, stringToPush, extraFunc, addToStartIndex) => {
    if (!addToStartIndex)
        addToStartIndex = 0;
    ...
    const startIndex = typeof handlerA === "number"
